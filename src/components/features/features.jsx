...
const Features = () => {
    const features = [
        { imageSrc: Dirt, title: 'Без грязи' },
        { imageSrc: Long_t, title: 'Долгое хранение' },
        { imageSrc: taste, title: 'Яркий вкус' },
        { imageSrc: health, title: 'Полезный продукт' },
        { imageSrc: effect, title: 'Эффектная подача' },
    ];
